...
//Initialize table name variable as global due to scope issues - nk 04/20/18
QString tableNameStr = "x";
...
//Help button clicked
// Request Manager button clicked // nk 04/20/18 - fix label and add message as per requirement
...
void MainWindow::on_beginOrderButton_clicked()
{
    ...
    //Save table name to global variable - nk 04/20/18
    tableNameStr = ui->lineEdit_TableName->text();
...
void MainWindow::endSession()
{
    ...
    ui -> lineEdit_TableName -> setText("maximum 50 characters");
